...
namespace RocketElevatorsRESTAPI.Controllers
{
    ...
    public class BatteriesController : ControllerBase
    {
        ...
        [HttpGet("buildings/{requestedID:int}")]
        public async Task<ActionResult<IEnumerable<Battery>>> GetBuildingsBatteries(int requestedID)
        {
            List<Battery> batteriesList = (await _context.batteries.ToListAsync()).Where(battery => battery.building_id == requestedID).ToList();
